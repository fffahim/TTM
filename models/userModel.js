...
module.exports = {
	 ...
	 insert : function(user,table,callback)
	 {
	 	...
	 	else if(table=='transport_bookings') sql = "insert into transport_bookings values ( NULL, '"+user.user_id+"'  , '"+user.user_email+"'  , '"+user.user_phone+"'  , '"+user.name+"' , '"+user.pickup+"' , '"+user.dropoff+"' , '"+user.time+"' , '"+user.price+"' , 'pending' ); "
